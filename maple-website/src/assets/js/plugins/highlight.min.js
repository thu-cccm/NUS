...
fixMarkup:e=>{
return K("10.2.0","fixMarkup will be removed entirely in v11.0"),K("10.2.0","Please see https:
t=e,
...
contains:[{className:"doctag",variants:[{begin:"
...
begin:t,relevance:0,starts:m}]},{className:"tag",begin:a(/<\
...
className:"regexp",variants:[{begin:/(m|qr)\/\
begin:d("(?:m|qr)?",/\
